...
После успешного выполнения основных действий лабораторной работы напишите скрипт автоматизации процесса создания резервной копии с сохранением вне устройства Mikrotik. Для этого можно использовать любой способ, пришедший Вам на ум: внешнее устройство, сетевое хранилище, облачное хранилише, электронное письмо или другие.
